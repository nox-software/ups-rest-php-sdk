...
class PortOfEntry extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * Address of the POE. For Master/Child Shipment
     *
     * @return PortOfEntryAddress
     */
    public function getAddress(): PortOfEntryAddress
    {
        return $this->address;
    }
    /**
     * Address of the POE. For Master/Child Shipment
     *
     * @param PortOfEntryAddress $address
     *
     * @return self
     */
    public function setAddress(PortOfEntryAddress $address): self
    {
