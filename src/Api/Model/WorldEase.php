...
class WorldEase extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * @return PortOfEntry
     */
    public function getPortOfEntry(): PortOfEntry
    {
        return $this->type;
    }
    /**
     * Container for port of entry details
     *
     * @param PortOfEntry $portOfEntry
     *
     * @return self
     */
    public function setPortOfEntry(PortOfEntry $portOfEntry): self
    {
